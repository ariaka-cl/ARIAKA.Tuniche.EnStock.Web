...
Namespace Migrations
    ...
    Public NotInheritable Partial Class detallesalidas
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(detallesalidas))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201803070105513_detalle-salidas"
            End Get
        End Property
