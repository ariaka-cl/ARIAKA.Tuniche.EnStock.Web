...
Namespace Migrations
    ...
    Public NotInheritable Partial Class add_bodega_salida
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(add_bodega_salida))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201712080452372_add_bodega_salida"
            End Get
        End Property
