...
Namespace Migrations
    ...
    Public NotInheritable Partial Class add_historico
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(add_historico))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201802030334396_add_historico"
            End Get
        End Property
